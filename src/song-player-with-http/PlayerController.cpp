    ...
    : QAbstractListModel{ parent }
{
    ...
    addAudio(
        ...
        QUrl("qrc:qt/qml/SongPlayerWithHttp/src/song-player-with-http/assets/audio/"
             "eine_kleine_nachtmusik.mp3"),
        QUrl("qrc:qt/qml/SongPlayerWithHttp/src/song-player-with-http/assets/images/song_1.jpg"));
    ...
    addAudio(
        ...
        QUrl("qrc:qt/qml/SongPlayerWithHttp/src/song-player-with-http/assets/audio/"
             "symphony_no_5.mp3"),
        QUrl("qrc:qt/qml/SongPlayerWithHttp/src/song-player-with-http/assets/images/song_2.jpg"));

    addAudio(
        "Air on the G String",
        "Johann Sebastian Bach",
        QUrl("qrc:qt/qml/SongPlayerWithHttp/src/song-player-with-http/assets/audio/"
             "air_on_the_g_string.mp3"),
        QUrl("qrc:qt/qml/SongPlayerWithHttp/src/song-player-with-http/assets/images/song_3.jpg"),
        QUrl("qrc:qt/qml/SongPlayerWithHttp/src/song-player-with-http/assets/videos/video_1.avi"));
}
