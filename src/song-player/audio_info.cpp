...
{
    if (m_songIndex == newSongIndex) return;
...
{
    if (m_authorName == newAuthorName) return;
...
{
    if (m_imageSource == newImageSource) return;
...
{
    if (m_videoSource == newVideoSource) return;
...
{
    if (m_audioSource == newAudioSource) return;
